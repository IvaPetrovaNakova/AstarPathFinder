...
public class Graph {
    ...
    private HashMap<String, Integer> cities;   //in this hash map, the key is the city name, and the value is its
...
//    }
     ...
     * @param lon   longitude
     */
    public void addVertex(String v1,double latitude, double lon){
        cities.put(v1,numVertices); //put into the hashmap to store its index in the vertices array
        Vertex vert = new Vertex(latitude, lon,v1); //create a new vertex

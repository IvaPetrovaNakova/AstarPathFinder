...
public class State<E> {
    ...
    public State(Node<E> currentNode, int gCost, int hValue,
                 State<E> prevState, List<Job<E>> jobs) {
    ...
    public boolean equals(Object o) {
        if (this.getClass().equals(o.getClass())) {
            ...
            State<E> s = (State<E>) o;
            //two states are equals if they have the same current node, previous node and gCost
            if (prevState != null && s.prevState != null) {
                return this.currentNode.equals(s.currentNode) &&
                        this.prevState.getCurrNode().equals(s.prevState.getCurrNode()) &&
                                this.gCost == s.gCost;
            } else {
                return this.currentNode.equals(s.currentNode);
            }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(currentNode, prevState, gCost, fCost, jobs, hValue);
    }
